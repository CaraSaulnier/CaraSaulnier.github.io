...
Row 2: Purl to last st, **take yarn to back bwetween needles, slip last stitch purlwise to right-hand needle, bring yarn to front between needles, slip stitch back to left-hand needle (WS W&T complete), turn**.
Row 3: Knit to 1 st befor the last wrapped st of the heel, work as from * to * to complete a RS W&T.
Row 4: Purl ot 1 st befor the last wrapped st of the heel, work as from ** to ** to complete a WS W&T.
...
Row 1 (RS): Knit to the first wrapped st, pick up wrapped st and knit it together with st on needl, W&T the next st (this st now has 2 wraps).
Row 2: Purl to first wrapped st pick up wrapped st and purl it toghter with st on needl, W&T the next st (this st now has 2 wraps).
Row 3: Knit to st with dounle wrap, pick up both wraps and knit them together with st on needle, W&T the next st.
